      ...
      <section className="py-16 bg-[#F7F7FB]">
        <div className="mx-auto max-w-5xl px-6">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <Link href="/attractions/en/cappadocia" className="group flex items-center gap-4 rounded-2xl bg-white border border-black/[0.06] p-5 hover:border-[#6C4CF1]/30 transition-colors">
              <span className="text-3xl">🎈</span>
              <div>
                <p className="font-black text-[#0A0A0F] group-hover:text-[#6C4CF1] transition-colors">Cappadocia Travel Guide</p>
                <p className="text-sm text-neutral-400">Fairy chimneys, valleys & balloon tips</p>
              </div>
            </Link>
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 2, name: "Cappadocia Tour Guide", item: "https://www.vibeguideapp.com/cappadocia-tour-guide" },
            ],
          }),
        }}
      />
