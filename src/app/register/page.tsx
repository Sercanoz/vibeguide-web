    ...
    <main className="min-h-screen bg-white flex items-center justify-center px-4">
      ...
      <div className="relative w-full max-w-lg">
        ...
        <div className="text-center mb-10">
          ...
          <p className="mt-1 text-sm text-neutral-700">How would you like to use VibeGuide?</p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          ...
          >
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-neutral-700 leading-6">Discover cities with verified local guides. Book instant tours or plan ahead.</p>
            </div>
          ...
          >
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-neutral-700 leading-6">Share your city&apos;s stories. Earn income doing what you love with verified tourists.</p>
            </div>
