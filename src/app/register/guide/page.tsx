    ...
    return (
      <main className="min-h-screen bg-white flex items-center justify-center px-4">
        ...
        <div className="relative w-full max-w-md text-center">
          ...
          <p className="mt-3 text-sm text-neutral-800 leading-7 max-w-xs mx-auto">
          ...
          <p className="mt-2 text-sm text-neutral-800">We&apos;ll email you at <strong className="text-[#0A0A0F]">{email}</strong> once approved.</p>
          <a
            href="/"
    ...
    return (
      <main className="min-h-screen bg-white flex items-center justify-center px-4">
        ...
        <div className="relative w-full max-w-md text-center">
          ...
          <p className="mt-2 text-sm text-neutral-800 max-w-xs mx-auto leading-6">
    ...
    <main className="min-h-screen bg-white flex items-center justify-center px-4 py-12">
      ...
      <div className="relative w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="mt-1 text-sm text-neutral-800">Your application will be reviewed within 1–2 days</p>
        </div>
        ...
        <div className="bg-white border border-black/[0.06] rounded-3xl p-8 shadow-sm">
          ...
          <div className="flex items-center gap-3 my-5">
            ...
            <span className="text-xs text-neutral-800 font-medium">or sign up with email</span>
            <div className="flex-1 h-px bg-black/[0.06]" />
          </div>
          ...
          <form onSubmit={onSubmit} className="space-y-4">
            ...
            {/* Badge photos */}
            <div>
              <label className="text-xs font-bold text-neutral-700 mb-2 block">Guide badge photos *</label>
              ...
              <p className="text-[10px] text-neutral-800 mt-1.5">Upload clear photos of your official guide badge</p>
            </div>
            ...
            <div>
              <label className="text-xs font-bold text-neutral-700 mb-1.5 block">Confirm password *</label>
