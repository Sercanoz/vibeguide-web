  ...
  return (
    <main className="min-h-screen bg-white text-[#0A0A0F]">
      ...
      <div className="mx-auto max-w-3xl px-6 pt-28 pb-16">
        ...
        <p className="text-lg text-neutral-700 leading-8 mb-6">
        ...
        <p className="text-neutral-700 leading-8 mb-8">
        ...
        <p className="text-neutral-700 leading-7 mb-4">VibeGuide offers three ways to discover a destination:</p>
        ...
        <ul className="list-disc pl-5 space-y-1.5 text-neutral-700 leading-7 mb-8">
