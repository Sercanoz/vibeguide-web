...
// /attractions hub sayfası metinleri (dile göre).
export const ATTR_HUB: Record<AttractionLang, { metaTitle: string; metaDescription: string; h1: string; intro: string }> = {
  en: { metaTitle: "Turkey's Top Attractions — Tours with Local Guides", metaDescription: "Explore Turkey's greatest landmarks — from Hagia Sophia and Cappadocia to Ephesus, Pamukkale and Göbeklitepe — with a verified local guide.", h1: "Turkey's Top Attractions", intro: "From Istanbul's mosques to ancient Ephesus and the world's oldest temple, discover every landmark with a verified local guide." },
  de: { metaTitle: "Die Top-Sehenswürdigkeiten der Türkei — Touren mit lokalen Guides", metaDescription: "Entdecke die größten Wahrzeichen der Türkei — von der Hagia Sophia und Kappadokien bis Ephesos, Pamukkale und Göbeklitepe — mit einem geprüften lokalen Guide.", h1: "Die Top-Sehenswürdigkeiten der Türkei", intro: "Von Istanbuls Moscheen über das antike Ephesos bis zum ältesten Tempel der Welt — entdecke jedes Wahrzeichen mit einem geprüften lokalen Guide." },
  ru: { metaTitle: "Главные достопримечательности Турции — экскурсии с местными гидами", metaDescription: "Откройте величайшие памятники Турции — от Айя-Софии и Каппадокии до Эфеса, Памуккале и Гёбекли-Тепе — с проверенным местным гидом.", h1: "Главные достопримечательности Турции", intro: "От мечетей Стамбула до античного Эфеса и древнейшего храма мира — откройте каждую достопримечательность с проверенным местным гидом." },
  ar: { metaTitle: "أبرز معالم تركيا — جولات مع مرشدين محليين", metaDescription: "استكشف أعظم معالم تركيا — من آيا صوفيا وكابادوكيا إلى أفسس وباموكالي وغوبكلي تبه — مع مرشد محلي موثّق.", h1: "أبرز معالم تركيا", intro: "من مساجد إسطنبول إلى أفسس القديمة وأقدم معبد في العالم — اكتشف كل معلم مع مرشد محلي موثّق." },
  es: { metaTitle: "Las Mejores Atracciones de Turquía — Tours con Guías Locales", metaDescription: "Explora los grandes monumentos de Turquía — de Santa Sofía y Capadocia a Éfeso, Pamukkale y Göbeklitepe — con un guía local verificado.", h1: "Las Mejores Atracciones de Turquía", intro: "De las mezquitas de Estambul a la antigua Éfeso y el templo más antiguo del mundo, descubre cada lugar con un guía local verificado." },
  fr: { metaTitle: "Les Sites Incontournables de Turquie — Visites avec Guides Locaux", metaDescription: "Explorez les plus grands monuments de Turquie — de Sainte-Sophie et la Cappadoce à Éphèse, Pamukkale et Göbeklitepe — avec un guide local vérifié.", h1: "Les Sites Incontournables de Turquie", intro: "Des mosquées d'Istanbul à l'antique Éphèse et au plus ancien temple du monde, découvrez chaque site avec un guide local vérifié." },
  el: { metaTitle: "Τα Κορυφαία Αξιοθέατα της Τουρκίας — Ξεναγήσεις με Ντόπιους Ξεναγούς", metaDescription: "Εξερευνήστε τα μεγαλύτερα μνημεία της Τουρκίας — από την Αγία Σοφία και την Καππαδοκία μέχρι την Έφεσο, το Παμούκαλε και το Γκιομπεκλί Τεπέ — με πιστοποιημένο ντόπιο ξεναγό.", h1: "Τα Κορυφαία Αξιοθέατα της Τουρκίας", intro: "Από τα τζαμιά της Κωνσταντινούπολης ως την αρχαία Έφεσο και τον αρχαιότερο ναό του κόσμου, ανακαλύψτε κάθε αξιοθέατο με πιστοποιημένο ντόπιο ξεναγό." },
  tr: { metaTitle: "Türkiye'nin Öne Çıkan Yerleri — Yerel Rehberlerle Turlar", metaDescription: "Türkiye'nin en büyük simgelerini — Ayasofya ve Kapadokya'dan Efes, Pamukkale ve Göbeklitepe'ye — onaylı bir yerel rehberle keşfedin.", h1: "Türkiye'nin Öne Çıkan Yerleri", intro: "İstanbul'un camilerinden antik Efes'e ve dünyanın en eski tapınağına — her yeri onaylı bir yerel rehberle keşfedin." },
