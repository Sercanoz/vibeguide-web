...
const en: Dict = {
  ...
  hero: {
    ...
    seoLine: "Book licensed local guides and private, group and walking tours in Turkey — Istanbul, Cappadocia, Ephesus, Antalya and more.",
  ...
  modes: {
    ...
    private: { tag: "PRIVATE TOURS · PLANNED", title: "Your day, perfectly tailored.",
      text: "Choose your date, language and preferred pace. VibeGuide confirms the route and assigns a verified licensed guide based on availability — Hagia Sophia at sunrise, Bosphorus by boat, food crawl by night.",
      points: ["🎓 Licensed tourist guides", "🗣️ 9+ language options", "🗺️ Curated routes, zero surprises"],
      cta: "Reserve Now" },
  },
  manifesto: {
...
const tr: Dict = {
  ...
  hero: {
    ...
    seoLine: "Türkiye'de ruhsatlı yerel rehberlerle özel, grup ve yürüyüş turları — İstanbul, Kapadokya, Efes, Antalya ve daha fazlası.",
  ...
  modes: {
    ...
    private: { tag: "ÖZEL TURLAR · PLANLI", title: "Günün, tam sana göre.",
      text: "Tarihini, dilini ve temponu seç. Rotayı VibeGuide belirler ve müsaitliğe göre doğrulanmış lisanslı bir rehber atar — gün doğumunda Ayasofya, teknede Boğaz, gece lezzet turu.",
      points: ["🎓 Ruhsatlı turist rehberleri", "🗣️ 9+ dil seçeneği", "🗺️ Özenle hazırlanmış rotalar, sürpriz yok"],
      cta: "Rezervasyon Yap" },
  },
  manifesto: {
...
const de: Dict = {
  ...
  hero: {
    ...
    seoLine: "Lizenzierte lokale Guides sowie private, Gruppen- und Wandertouren in der Türkei — Istanbul, Kappadokien, Ephesus, Antalya und mehr.",
  ...
  modes: {
    ...
    private: { tag: "PRIVATE TOUREN · GEPLANT", title: "Dein Tag, perfekt zugeschnitten.",
      text: "Wähle Datum, Sprache und Tempo. VibeGuide bestätigt die Route und weist je nach Verfügbarkeit einen geprüften lizenzierten Guide zu — Hagia Sophia bei Sonnenaufgang, Bosporus per Boot, Food-Tour bei Nacht.",
      points: ["🎓 Lizenzierte Touristenführer", "🗣️ 9+ Sprachoptionen", "🗺️ Kuratierte Routen, keine Überraschungen"],
...
const ru: Dict = {
  ...
  hero: {
    ...
    seoLine: "Лицензированные местные гиды и частные, групповые и пешеходные туры по Турции — Стамбул, Каппадокия, Эфес, Анталья и другие.",
  ...
  modes: {
    ...
    private: { tag: "ЧАСТНЫЕ ТУРЫ · ПЛАНОВО", title: "Ваш день, идеально для вас.",
      text: "Выберите дату, язык и темп. VibeGuide подтверждает маршрут и назначает проверенного лицензированного гида с учётом доступности — Айя-София на рассвете, Босфор на катере, гастротур вечером.",
      points: ["🎓 Лицензированные гиды", "🗣️ 9+ языков", "🗺️ Продуманные маршруты, без сюрпризов"],
      cta: "Забронировать" },
  },
  manifesto: {
...
const es: Dict = {
  ...
  hero: {
    ...
    seoLine: "Guías locales con licencia y tours privados, en grupo y a pie por Turquía — Estambul, Capadocia, Éfeso, Antalya y más.",
  ...
  modes: {
    ...
    private: { tag: "TOURS PRIVADOS · PLANIFICADO", title: "Tu día, hecho a tu medida.",
      text: "Elige tu fecha, idioma y ritmo. VibeGuide confirma la ruta y asigna un guía con licencia verificado según la disponibilidad — Santa Sofía al amanecer, el Bósforo en barco, ruta gastronómica de noche.",
      points: ["🎓 Guías turísticos licenciados", "🗣️ 9+ idiomas", "🗺️ Rutas cuidadas, cero sorpresas"],
      cta: "Reservar ahora" },
  },
  manifesto: {
...
const ja: Dict = {
  ...
  hero: {
    ...
    seoLine: "トルコの公認現地ガイドと、プライベート・グループ・ウォーキングツアー — イスタンブール、カッパドキア、エフェソス、アンタルヤほか。",
  ...
  modes: {
    ...
    private: { tag: "プライベートツアー · 計画", title: "あなたの一日、完璧に仕立てる。",
      text: "日程・言語・ペースを選ぶだけ。VibeGuide がルートを確定し、空き状況に応じて認定ガイドを手配します — 日の出のアヤソフィア、ボスポラス海峡クルーズ、夜のフードツアー。",
      points: ["🎓 公認観光ガイド", "🗣️ 9以上の言語", "🗺️ 厳選ルート、想定外なし"],
      cta: "今予約する" },
  },
  manifesto: {
...
const zh: Dict = {
  ...
  hero: {
    ...
    seoLine: "土耳其持牌当地向导，以及私人、团队和步行游览 — 伊斯坦布尔、卡帕多奇亚、以弗所、安塔利亚等。",
  ...
  modes: {
    ...
    private: { tag: "私人导览 · 计划", title: "你的一天,量身定制。",
      text: "选择日期、语言和节奏。VibeGuide 确认路线，并根据可预约情况为你指派经认证的持照向导——日出时的圣索菲亚、乘船游博斯普鲁斯、夜晚美食之旅。",
      points: ["🎓 持牌导游", "🗣️ 9种以上语言", "🗺️ 精选路线，绝无意外"],
      cta: "立即预订" },
  },
  manifesto: {
...
const el: Dict = {
  ...
  hero: {
    ...
    seoLine: "Αδειοδοτημένοι τοπικοί ξεναγοί και ιδιωτικές, ομαδικές και πεζοπορικές ξεναγήσεις στην Τουρκία — Κωνσταντινούπολη, Καππαδοκία, Έφεσος, Αττάλεια και άλλα.",
  ...
  modes: {
    ...
    private: { tag: "ΙΔΙΩΤΙΚΕΣ · ΠΡΟΓΡΑΜΜΑΤΙΣΜΕΝΟ", title: "Η μέρα σου, τέλεια προσαρμοσμένη.",
      text: "Διάλεξε ημερομηνία, γλώσσα και ρυθμό. Το VibeGuide επιβεβαιώνει τη διαδρομή και αναθέτει πιστοποιημένο αδειούχο ξεναγό ανάλογα με τη διαθεσιμότητα — Αγία Σοφία στην ανατολή, Βόσπορος με σκάφος, γαστρονομική βόλτα το βράδυ.",
      points: ["🎓 Αδειούχοι τουριστικοί ξεναγοί", "🗣️ 9+ γλώσσες", "🗺️ Επιμελημένες διαδρομές, καμία έκπληξη"],
      cta: "Κράτηση τώρα" },
  },
  manifesto: {
...
const bg: Dict = {
  ...
  hero: {
    ...
    seoLine: "Лицензирани местни водачи и частни, групови и пешеходни турове в Турция — Истанбул, Кападокия, Ефес, Анталия и още.",
  ...
  modes: {
    ...
    private: { tag: "ЧАСТНИ · ПЛАНИРАНИ", title: "Твоят ден, перфектно изработен.",
      text: "Изберете дата, език и темпо. VibeGuide потвърждава маршрута и назначава проверен лицензиран водач според наличността — Света София на изгрев, Босфора с лодка, кулинарна обиколка вечер.",
      points: ["🎓 Лицензирани водачи", "🗣️ 9+ езика", "🗺️ Подбрани маршрути, без изненади"],
      cta: "Резервирай сега" },
  },
  manifesto: {
...
const sr: Dict = {
  ...
  hero: {
    ...
    seoLine: "Licencirani lokalni vodiči te privatne, grupne i pješačke ture u Turskoj — Istanbul, Kapadokija, Efez, Antalija i više.",
  ...
  modes: {
    ...
    private: { tag: "PRIVATNE · PLANIRANE", title: "Tvoj dan, savršeno skrojen.",
      text: "Izaberite datum, jezik i tempo. VibeGuide potvrđuje rutu i dodeljuje proverenog licenciranog vodiča prema dostupnosti — Aja Sofija u zoru, Bosfor brodom, gastro tura uveče.",
      points: ["🎓 Licencirani turistički vodiči", "🗣️ 9+ jezika", "🗺️ Pažljivo odabrane rute, bez iznenađenja"],
      cta: "Rezerviši sada" },
  },
  manifesto: {
...
const ko: Dict = {
  ...
  hero: {
    ...
    seoLine: "튀르키예의 면허 소지 현지 가이드와 프라이빗·그룹·워킹 투어 — 이스탄불, 카파도키아, 에페소스, 안탈리아 등.",
  ...
  modes: {
    ...
    private: { tag: "프라이빗 · 계획", title: "당신의 하루, 완벽한 맞춤.",
      text: "날짜, 언어, 원하는 속도를 고르세요. VibeGuide가 경로를 확정하고 가능 여부에 따라 검증된 자격 가이드를 배정합니다 — 해돋이의 아야소피아, 보스포루스 보트, 밤의 미식 투어.",
      points: ["🎓 공인 관광 가이드", "🗣️ 9개 이상 언어", "🗺️ 엄선된 코스, 예상치 못한 일 없음"],
      cta: "지금 예약" },
  },
  manifesto: {
...
const it: Dict = {
  ...
  hero: {
    ...
    seoLine: "Guide locali autorizzate e tour privati, di gruppo e a piedi in Turchia — Istanbul, Cappadocia, Efeso, Adalia e altro.",
  ...
  modes: {
    ...
    private: { tag: "TOUR PRIVATI · PIANIFICATO", title: "La tua giornata, su misura.",
      text: "Scegli data, lingua e ritmo. VibeGuide conferma l'itinerario e assegna una guida autorizzata verificata in base alla disponibilità — Santa Sofia all'alba, il Bosforo in barca, tour gastronomico la sera.",
      points: ["🎓 Guide turistiche abilitate", "🗣️ 9+ lingue", "🗺️ Itinerari curati, zero sorprese"],
      cta: "Prenota ora" },
  },
  manifesto: {
...
const hr: Dict = {
  ...
  hero: {
    ...
    seoLine: "Licencirani lokalni vodiči i privatne, grupne i pješačke ture u Turskoj — Istanbul, Kapadokija, Efez, Antalija i više.",
  ...
  modes: {
    ...
    private: { tag: "PRIVATNE · PLANIRANE", title: "Tvoj dan, savršeno skrojen.",
      text: "Odaberite datum, jezik i tempo. VibeGuide potvrđuje rutu i dodjeljuje provjerenog licenciranog vodiča prema dostupnosti — Aja Sofija u zoru, Bospor brodom, gastro tura navečer.",
      points: ["🎓 Licencirani turistički vodiči", "🗣️ 9+ jezika", "🗺️ Pomno odabrane rute, bez iznenađenja"],
      cta: "Rezerviraj sada" },
  },
  manifesto: {
    eyebrow: "Zašto postoji VibeGuide",
...
const fr: Dict = {
  ...
  hero: {
    ...
    seoLine: "Guides locaux agréés et circuits privés, en groupe et à pied en Turquie — Istanbul, Cappadoce, Éphèse, Antalya et plus.",
  ...
  modes: {
    ...
    private: { tag: "PRIVÉ · PLANIFIÉ", title: "Ta journée, parfaitement taillée.", text: "Choisissez votre date, votre langue et votre rythme. VibeGuide confirme l'itinéraire et attribue un guide agréé vérifié selon les disponibilités — Sainte-Sophie au lever du soleil, le Bosphore en bateau, tournée gourmande le soir.", points: ["🎓 Guides touristiques agréés", "🗣️ 9+ langues", "🗺️ Itinéraires soignés, zéro surprise"], cta: "Réserver maintenant" },
  },
...
const ro: Dict = {
  ...
  hero: {
    ...
    seoLine: "Ghizi locali autorizați și tururi private, de grup și pe jos în Turcia — Istanbul, Capadocia, Efes, Antalya și altele.",
  ...
  modes: {
    ...
    private: { tag: "PRIVAT · PLANIFICAT", title: "Ziua ta, perfect croită.", text: "Alege data, limba și ritmul. VibeGuide confirmă traseul și îți atribuie un ghid licențiat verificat în funcție de disponibilitate — Hagia Sofia în zori, Bosforul cu barca, tur culinar seara.", points: ["🎓 Ghizi turistici autorizați", "🗣️ 9+ limbi", "🗺️ Trasee atent alese, fără surprize"], cta: "Rezervă acum" },
  },
...
const ar: Dict = {
  ...
  hero: {
    ...
    seoLine: "مرشدون محليون مرخّصون وجولات خاصة وجماعية ومشي في تركيا — إسطنبول، كابادوكيا، أفسس، أنطاليا وغيرها.",
  ...
  modes: {
    ...
    private: { tag: "خاص · مخطط", title: "يومك، مصمم بالكامل لك.", text: "اختر التاريخ واللغة والوتيرة. يؤكد VibeGuide المسار ويعيّن مرشدًا مرخّصًا موثّقًا حسب التوفّر — آيا صوفيا عند الشروق، البوسفور بالقارب، جولة طعام ليلًا.", points: ["🎓 مرشدون سياحيون مرخّصون", "🗣️ 9+ لغات", "🗺️ مسارات منتقاة، بلا مفاجآت"], cta: "احجز الآن" },
  },
...
const nl: Dict = {
  ...
  hero: {
    ...
    seoLine: "Erkende lokale gidsen en privé-, groeps- en wandeltours in Turkije — Istanbul, Cappadocië, Efeze, Antalya en meer.",
  ...
  modes: {
    ...
    private: { tag: "PRIVÉ · GEPLAND", title: "Jouw dag, perfect op maat.", text: "Kies je datum, taal en tempo. VibeGuide bevestigt de route en wijst op basis van beschikbaarheid een geverifieerde gediplomeerde gids toe — Hagia Sophia bij zonsopgang, de Bosporus per boot, foodtour in de avond.", points: ["🎓 Gecertificeerde gidsen", "🗣️ 9+ talen", "🗺️ Zorgvuldige routes, geen verrassingen"], cta: "Nu boeken" },
  },
...
const pl: Dict = {
  ...
  hero: {
    ...
    seoLine: "Licencjonowani lokalni przewodnicy oraz prywatne, grupowe i piesze wycieczki po Turcji — Stambuł, Kapadocja, Efez, Antalya i więcej.",
  ...
  modes: {
    ...
    private: { tag: "PRYWATNY · ZAPLANOWANY", title: "Twój dzień, idealnie szyty na miarę.", text: "Wybierz datę, język i tempo. VibeGuide potwierdza trasę i przydziela zweryfikowanego licencjonowanego przewodnika w zależności od dostępności — Hagia Sophia o wschodzie słońca, Bosfor łodzią, tour kulinarny wieczorem.", points: ["🎓 Certyfikowani przewodnicy", "🗣️ 9+ języków", "🗺️ Dopracowane trasy, zero niespodzianek"], cta: "Zarezerwuj teraz" },
  },
...
const uk: Dict = {
  ...
  hero: {
    ...
    seoLine: "Ліцензовані місцеві гіди та приватні, групові й піші тури Туреччиною — Стамбул, Каппадокія, Ефес, Анталія та інші.",
  ...
  modes: {
    ...
    private: { tag: "ПРИВАТНИЙ · ЗАПЛАНОВАНИЙ", title: "Твій день, ідеально скроєний.", text: "Оберіть дату, мову й темп. VibeGuide підтверджує маршрут і призначає перевіреного ліцензованого гіда з урахуванням доступності — Свята Софія на світанку, Босфор човном, гастротур увечері.", points: ["🎓 Ліцензовані гіди", "🗣️ 9+ мов", "🗺️ Продумані маршрути, без сюрпризів"], cta: "Забронювати зараз" },
  },
...
const id: Dict = {
  ...
  hero: {
    ...
    seoLine: "Pemandu lokal berlisensi serta tur privat, grup, dan jalan kaki di Turki — Istanbul, Kapadokia, Efesus, Antalya, dan lainnya.",
  ...
  modes: {
    ...
    private: { tag: "PRIVAT · TERENCANA", title: "Harimu, sempurna dibuat khusus untukmu.", text: "Pilih tanggal, bahasa, dan ritme yang kamu mau. VibeGuide memastikan rute dan menugaskan pemandu berlisensi terverifikasi sesuai ketersediaan — Hagia Sophia saat matahari terbit, Bosphorus naik kapal, wisata kuliner malam.", points: ["🎓 Pemandu wisata berlisensi", "🗣️ 9+ bahasa", "🗺️ Rute pilihan, tanpa kejutan"], cta: "Pesan sekarang" },
  },
...
const pt: Dict = {
  ...
  hero: {
    ...
    seoLine: "Guias locais licenciados e passeios privados, em grupo e a pé na Turquia — Istambul, Capadócia, Éfeso, Antália e mais.",
  ...
  modes: {
    ...
    private: { tag: "PRIVADO · PLANEADO", title: "O teu dia, perfeitamente feito à medida.", text: "Escolhe a data, o idioma e o ritmo. A VibeGuide confirma o percurso e atribui um guia licenciado verificado consoante a disponibilidade — Santa Sofia ao nascer do sol, o Bósforo de barco, rota gastronómica à noite.", points: ["🎓 Guias turísticos licenciados", "🗣️ 9+ línguas", "🗺️ Percursos curados, zero surpresas"], cta: "Reservar agora" },
  },
