    ...
    <div ref={overlayRef}
      ...
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md overflow-hidden relative">
        <button onClick={dismiss}
          className="absolute top-4 right-4 z-10 w-8 h-8 rounded-full bg-white/80 backdrop-blur flex items-center justify-center text-neutral-400 hover:text-neutral-700 transition-colors text-sm">
          ✕
        </button>
          ...
          {state === "done" ? (
            <div className="text-center">
              ...
              <div className="mt-5 bg-[#F7F7FB] border-2 border-dashed border-[#6C4CF1] rounded-2xl py-4">
                <p className="text-[10px] font-bold text-neutral-400 uppercase tracking-widest">Your code</p>
            ...
            <>
              ...
              <button onClick={dismiss} className="mt-3 w-full text-center text-xs text-neutral-400 hover:text-neutral-600 transition-colors">
                No thanks, maybe later
              </button>
              <p className="mt-3 text-[10px] text-neutral-300 text-center">
