...
export default function ShareButton({ url, title, variant = "button" }: Props) {
  ...
  const trigger = variant === "icon" ? (
    ...
    <button onClick={nativeOrToggle}
      className="inline-flex items-center gap-2 rounded-full border border-black/10 px-4 py-2 text-sm font-bold text-neutral-600 hover:border-[#6C4CF1] hover:text-[#6C4CF1] transition-colors">
