        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 h-16">
          ...
          <div className="hidden md:flex items-center gap-1 text-sm font-medium"
            ...
            <div className="relative" onMouseEnter={() => setOpenMenu("destinations")}>
              <button
                className={`flex items-center gap-1 px-3.5 py-2 rounded-xl font-medium cursor-pointer transition-all ${openMenu === "destinations" ? "text-[#6C4CF1] bg-[#6C4CF1]/[0.06]" : "text-neutral-400 hover:text-[#6C4CF1] hover:bg-[#6C4CF1]/[0.06]"}`}>
                {nb.destinations}
