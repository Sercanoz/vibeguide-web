  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-56 bg-white border-r border-black/[0.06] flex flex-col z-40 overflow-y-auto">
      ...
      <div className="px-5 py-5 border-b border-black/[0.06]">
        <Link href="/admin" className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <p className="text-[10px] font-semibold text-neutral-800 mt-0.5">Admin Panel</p>
          </div>
        </Link>
      </div>
      ...
      <nav className="flex-1 px-3 py-4 space-y-5">
        {NAV.map((group) => (
          <div key={group.group}>
            <p className="text-[9px] font-black uppercase tracking-[0.2em] text-neutral-800 px-2 mb-1.5">{group.group}</p>
                ...
                <Link
                  ...
                  className={`flex items-center gap-2.5 px-2.5 py-2 rounded-xl text-sm font-semibold transition-all ${
                    isActive(item.href, item.exact)
                      ...
                      : "text-neutral-700 hover:bg-neutral-50 hover:text-[#0A0A0F]"
                  }`}
                >
                  <span className={isActive(item.href, item.exact) ? "text-white" : "text-neutral-800"}>
                    {item.icon}
                  </span>
                  {item.label}
                </Link>
      ...
      <div className="px-3 py-4 border-t border-black/[0.06] space-y-0.5">
        <Link href="/" className="flex items-center gap-2.5 px-2.5 py-2 rounded-xl text-sm font-semibold text-neutral-800 hover:bg-neutral-50 hover:text-[#0A0A0F] transition-all">
